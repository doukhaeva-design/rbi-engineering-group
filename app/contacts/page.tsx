                        ...
                        <div className={styles.formArea}>
                            ...
                            <form className={styles.form} onSubmit={handleSubmit}>
                                ...
                                <div style={{ marginTop: '10px' }}>
                                    ...
                                    {status === 'success' && (
                                        <p style={{ color: 'green', marginTop: '15px', fontWeight: 500 }}>Запрос успешно отправлен! Мы свяжемся с вами.</p>
                                    )}
                                    {status === 'error' && (
                                        <p style={{ color: 'red', marginTop: '15px', fontWeight: 500 }}>Произошла ошибка. Пожалуйста, попробуйте еще раз.</p>
                                    )}
                                </div>
