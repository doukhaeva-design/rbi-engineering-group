    ...
    const services = [
        {
            ...
            desc: "Проектируем и возводим модульные здания под ключ с быстрым вводом в эксплуатацию и адаптацией под условия объекта.",
            details: [
        ...
        },
        {
            ...
            desc: "Выполняем полный комплекс строительно-монтажных работ для промышленных и инфраструктурных объектов с соблюдением сроков и нормативов.",
            details: [
        ...
        },
        {
            ...
            desc: "Проектируем и монтируем инженерные системы, обеспечивая стабильную и безопасную эксплуатацию объекта.",
            details: [
        ...
        },
        {
            ...
            desc: "Выполняем внутреннюю и фасадную отделку с акцентом на долговечность, функциональность и аккуратное исполнение.",
            details: [
        ...
        },
        {
            ...
            desc: "Разрабатываем проектную документацию и решения по планированию с учётом требований объекта и этапов строительства.",
            details: [
        ...
        },
        {
            ...
            desc: "Выполняем монтаж и демонтаж оборудования и металлоконструкций с соблюдением техники безопасности и проектных требований.",
            details: [
            ...
            <section className={styles.hero}>
                ...
                <div className="container">
                    ...
                    <p className={styles.heroText}>
                        Мы выполняем строительные и инженерные работы, а также реализуем модульные решения под задачи бизнеса и инфраструктуры.
                    </p>
                </div>
            </section>
